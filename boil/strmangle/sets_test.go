...
func TestUpdateFieldSet(t *testing.T) {
	...
	tests := []struct {
		...
		{Cols: []string{"a", "b"}, PrimaryKeys: []string{"a"}, Out: []string{"b"}},
		{Cols: []string{"a", "b"}, PrimaryKeys: []string{"a"}, Whitelist: []string{"a"}, Out: []string{"a"}},
		{Cols: []string{"a", "b"}, PrimaryKeys: []string{"a"}, Whitelist: []string{"a", "b"}, Out: []string{"a", "b"}},
	}

	for i, test := range tests {
		set := UpdateFieldSet(test.Cols, test.PrimaryKeys, test.Whitelist)
...
func TestInsertFieldSet(t *testing.T) {
	t.Parallel()
	...
	for i, test := range tests {
		...
		set, ret := InsertFieldSet(test.Cols, test.Defaults, test.NoDefaults, test.NonZeroDefaults, test.Whitelist)
