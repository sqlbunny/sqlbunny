...
func (o *{{$tableNameSingular}}) doBeforeInsertHooks(ctx context.Context) (err error) {
...
func (o *{{$tableNameSingular}}) doBeforeUpdateHooks(ctx context.Context) (err error) {
...
func (o *{{$tableNameSingular}}) doBeforeDeleteHooks(ctx context.Context) (err error) {
...
func (o *{{$tableNameSingular}}) doBeforeUpsertHooks(ctx context.Context) (err error) {
...
func (o *{{$tableNameSingular}}) doAfterInsertHooks(ctx context.Context) (err error) {
...
func (o *{{$tableNameSingular}}) doAfterSelectHooks(ctx context.Context) (err error) {
...
func (o *{{$tableNameSingular}}) doAfterUpdateHooks(ctx context.Context) (err error) {
...
func (o *{{$tableNameSingular}}) doAfterDeleteHooks(ctx context.Context) (err error) {
...
func (o *{{$tableNameSingular}}) doAfterUpsertHooks(ctx context.Context) (err error) {
