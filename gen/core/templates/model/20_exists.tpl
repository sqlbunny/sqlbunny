...
func {{$modelNameSingular}}Exists(ctx context.Context{{range .Model.PrimaryKey.Fields}}, {{$f := $model.FindField .}}{{$f.Name | camelCase}} {{goType $f.Type.GoType}}{{end}}, selectCols ...{{$modelNameSingular}}Column) (bool, error) {
	var exists bool
