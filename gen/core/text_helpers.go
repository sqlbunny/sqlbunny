...
func init() {
	gen.TemplateFunctions["txtsFromFKey"] = txtsFromFKey
	gen.TemplateFunctions["txtsFromOneToOne"] = txtsFromOneToOne
	gen.TemplateFunctions["txtsFromToMany"] = txtsFromToMany
